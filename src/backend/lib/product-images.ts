...
// Helper function to process and upload product images
export async function uploadProductImagesHelper(productId: string, formData: FormData) {
  ...
  if (shouldRevalidate) {
    try {
      ...
      console.warn("Revalidation warning in uploadProductImagesHelper:", revErr);
    }
  }
