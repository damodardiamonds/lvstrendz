...
export default function Footer() {
  return (
    // Section 8: flex-direction row, gap 0, padding 0
      ...
      <div className="flex flex-col md:flex-row gap-0 p-0">
        ...
        <div className="w-full max-w-[1470px] mx-auto px-[45px] py-12 max-md:px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-6">
            {/* Brand Info */}
            <div>
              <h3 className="text-xl font-bold mb-4">LV&apos;s Trendz</h3>
              <p className="text-white/60 text-sm leading-relaxed">
                C-303 Bhavani Complex, Katargam,<br />
                Surat, Gujarat, India
              </p>
              <div className="mt-4 space-y-1">
                <p className="text-white/60 text-sm">📧 lvtrendz.info@gmail.com</p>
          ...
          <div className="border-t border-white/10 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-white/40 text-xs">
              © 2024 LV&apos;s Trendz. All Rights Reserved.
            </p>
            {/* Payment Icons */}
